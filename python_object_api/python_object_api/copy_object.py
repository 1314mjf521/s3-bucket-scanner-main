...
def copy_object(src_bucket_name, src_object_name, dest_bucket_name, dest_object_name):
    ...
    try:
        copy_source = "/{0}/{1}".format(src_bucket_name, src_object_name)  # 格式按照这个来，否者EDS不接受该请求
...
if __name__ == "__main__":
    ...
    copy_object(src_bucket_name, src_object_name, dest_bucket_name, dest_obejct_name)
