...
def delete_object_version(bucket_name, object_name, version_id):
    ...
    try:
        s3client.delete_object(Bucket=bucket_name, Key=object_name, VersionId=version_id)
...
if __name__ == "__main__":
    ...
    version_id = '1e8bbbadfc9847d064040000000373CA1'
    delete_object_version(bucket_name, object_name, version_id)
