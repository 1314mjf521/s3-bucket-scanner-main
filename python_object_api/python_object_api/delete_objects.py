...
def delete_objects(bucket_name, key1, key2):
    ...
    try:
        ...
        s3client.delete_objects(Bucket=bucket_name, Delete=delete_objects)
...
if __name__ == "__main__":
    bucket_name = "aa1"
    key1 = "Python-3.6.15.tgz"
    key2 = "hello"
    delete_objects(bucket_name, key1, key2)
